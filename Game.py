...
class Game():
	...
	def __init__(self, Turns = 10, nOfPlayers = 3, MaxMissConvergence = 1000):
		self.Event = Event()
	...
	def Play(self):
		...
		for Turn in range(self.Turns):
			if(self.DebugMode): print("\tTurn " + str(Turn))
			...
			self.House.PayAwards(self.Mask.Size, self.TempSolution["BestIndexes"], self.Players)
			bp()
